...
def calculate_metrics(forecast_start_day, sea_name, plot_metric=False, plot_maps=False):
    ...
    model_name = f'kara_cnn_att_2020(10)/weights/cnn_att_kara_19790101-20200101.pt'
    ...
    encoder = CNNAttention(channels_in=pre_history_size, out_channels=forecast_size)
